...
const ZOOM_LEVELS = Platform.OS === "ios"
  ? [{ label: "0.5×", value: 0 }, { label: "1×", value: 0.0625 }, { label: "2×", value: 0.125 }]
  : [{ label: "1×", value: 0 }, { label: "2×", value: 0.5 }];
...
export default function CameraScreen() {
  ...
  return (
    <View style={styles.container}>
      <CameraView ref={cameraRef} style={styles.camera} zoom={ZOOM_LEVELS[zoomIndex].value} />
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity onPress={cycleZoom} style={styles.zoomButton}>
          <Text style={styles.zoomText}>{ZOOM_LEVELS[zoomIndex].label}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
