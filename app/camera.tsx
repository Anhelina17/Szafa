  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomBar}>
        ...
        {/* Przycisk galerii z kropką */}
        <TouchableOpacity onPress={openGallery} style={[styles.galleryButton, { position: "relative" }]}>
          <View style={styles.galleryCircle}>
            <SvgXml xml={galleryIcon} width={s(27)} height={s(27)} />

          </View>
        </TouchableOpacity>

        {/* Przycisk zdjęcia — prosty biały okrąg */}
        <TouchableOpacity onPress={takePicture} style={styles.shutterButton}>
          <View style={styles.shutterCircle} />
        </TouchableOpacity>

        {/* Pusty element dla symetrii */}
